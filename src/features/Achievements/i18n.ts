  ...
  ru: {
    ...
    items: {
      ...
      dbms: {
        ...
        description:
          "Исследование производительности Django, SQLAlchemy, SQLModel, Peewee и Pony ORM на основе воспроизводимой методики тестирования в 14 CRUD-сценариях. Опубликовано в «Труды ИСП РАН».",
      },
      proxy: {
        title:
