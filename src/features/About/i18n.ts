...
export const aboutI18n: Record<Language, any> = {
  ru: {
    ...
    p1: "Меня зовут Александр. Я full-stack разработчик из Москвы с двухлетним опытом коммерческой и самостоятельной разработки веб-приложений. Основной стек — Django, React, TypeScript и PostgreSQL. Участвую в создании сервисов полного цикла: от проектирования структуры данных и серверной логики до реализации пользовательского интерфейса.",
  ...
  en: {
    ...
    p1: "I'm Alexander, a full-stack developer based in Moscow with two years of experience building web applications. My primary stack includes Django, React, TypeScript, and PostgreSQL. I work across the entire development lifecycle, from database design and backend implementation to responsive frontend interfaces.",
